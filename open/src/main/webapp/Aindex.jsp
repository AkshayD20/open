						...
						<ul>
							<li class="text">
								...
								<form method="get" class="searchform" action="Login"
									...
									<a href="registor.jsp"><input type="button"
										value="REGISTOR"
										style="margin: 10px; color: #fff; background-color: #d63847; display: inline-block; border-bottom-color: #215DA1; padding: 8px 15px; text-decoration: none; text-transform: uppercase;" /></a>
								</form>
								</p>
