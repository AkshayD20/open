...
<body>
	<div id="container">
		...
		<div id="body" class="width">
			...
			<form action="Bus" name="" onSubmit="return(validate());">
				...
				<table cellpadding="2" width="20%" bgcolor="99FFFF" align="center"
					...
					<tr>
						...
						<td><input type=text name="bno" id="textname" size="30"></td>
					...
					<tr>
						...
						<td><input type="text" name="btype" id="paddress" size="30"></td>
					...
					<tr>
						...
						<td><input type=text name="price" id="textname" size="30"></td>
					...
					<tr>
						...
						<td><input type=text name="seat" id="textname" size="30"></td>

					</tr>
					<tr>

						<td>Departuer Time</td>

						<td><input type="text" name="dtime" id="paddress" size="30"></td>
